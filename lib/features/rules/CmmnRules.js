...
CmmnRules.prototype.init = function() {
  ...
  this.addRule('connection.create', function(context) {
    ...
    if (window.foo) {
      console.log('CmmnRules', 'connection.create', context);
    }
...
CmmnRules.prototype.canConnect = function(source, target, connection) {
  ...
  if (window.foo) {
    console.log('CmmnRules#canConnect', source, target, connection);
  }
  ...
  if (this.canConnectDiscretionaryConnection(source, target, connection)) {
    console.log('#canConnect: canConnectDiscretionaryConnection')
    return {
